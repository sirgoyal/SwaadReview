...
const {campgroundSchema, reviewSchema}= require('./schemas'); //destructuring for particular validation schema
...
app.get('/campgrounds/:id', catchAsync(async (req, res) => {
    const campground = await Campground.findById(req.params.id).populate('reviews') // grabbing the CG by id and populating it with reviews.
